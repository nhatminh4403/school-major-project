        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScanningCount = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PromotionUser", x => new { x.PromotionsId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_PromotionUser_AspNetUsers_UsersId",
                        column: x => x.UsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PromotionUser_Promotions_PromotionsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ReceiptDetails_Schedules_ScheduleId",
                        column: x => x.ScheduleId,
                        principalTable: "Schedules",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ReceiptDetails_Seats_SeatId",
                        column: x => x.SeatId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReceiptDetails_ScheduleId",
                table: "ReceiptDetails",
                column: "ScheduleId");

            migrationBuilder.CreateIndex(
                name: "IX_ReceiptDetails_SeatId",
                table: "ReceiptDetails",
                column: "SeatId");

            migrationBuilder.CreateIndex(
                name: "IX_Receipts_ComboFoodId",
                table: "Receipts",
                column: "ComboFoodId");
